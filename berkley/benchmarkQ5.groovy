...
file = new File(".", 'benchmark_resultQ5.txt')

startTime = new Date()

file << "start time $startTime.time\n"
file << "\n------------------------------------------------\n"
file << "starting Q4: Get the input node of the input node and all its attributes of the nodes with\n" +
        "- number_of_atoms > 3 \n" +
        "- energy > 0\n"
startQ4 = new Date()
q4 = g.V.has('number_of_atoms', T.gt, 3).has('energy', T.gt, 0.0f).in('A').in.dedup().count()
endQ4 = new Date()
